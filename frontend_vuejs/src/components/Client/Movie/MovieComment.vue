<template>
  <div
    class="comment mx-auto mt-2 border border-neutral-800 bg-neutral-900 px-4 py-3 antialiased"
  >
    ...
    <div v-if="user" class="mb-6 border-b border-zinc-800 pb-2">
      <div
        class="mb-4 rounded-lg rounded-t-lg border border-zinc-700 bg-zinc-800 px-4 py-2"
      >
        <textarea
    ...
    <div v-else class="mb-10 text-sm opacity-75">
      ...
      <div>
        <article class="mb-3 text-sm">
          <div
            ...
            class="mt-2 rounded-lg border-t border-zinc-700 bg-zinc-800 p-3"
          >
            <div class="mb-2 flex items-center justify-between">
              <div class="flex items-center">
                <div
                  class="mr-3 inline-flex items-center text-sm font-semibold text-zinc-300"
                >
                  <div
                    class="mr-2 flex h-8 w-8 items-center justify-center rounded-full bg-zinc-600 font-bold uppercase"
                  >
            ...
            <!-- button -->
            <div
              class="relative mt-2 flex items-center space-x-2 text-xs font-medium text-zinc-300"
            >
