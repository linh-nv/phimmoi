...
class GenreController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return $this->responseError(Response::HTTP_INTERNAL_SERVER_ERROR, 'INTERNAL_ERROR', 'An error occurred while retrieving the Genres.');
        }
    }
    ...
    public function store(GenreRequest $request): JsonResponse
    {
        try {
            ...
            return $this->responseError(Response::HTTP_INTERNAL_SERVER_ERROR, 'INTERNAL_ERROR', 'An error occurred while creating the Genre.');
        }
    }
    ...
    public function show(Genre $genre): JsonResponse
    {
        try {
            ...
            return $this->responseError(Response::HTTP_INTERNAL_SERVER_ERROR, 'INTERNAL_ERROR', 'An error occurred while retrieving the Genre.');
        }
    }
    ...
    public function update(GenreRequest $request, Genre $genre): JsonResponse
    {
        try {
            ...
            return $this->responseError(Response::HTTP_INTERNAL_SERVER_ERROR, 'INTERNAL_ERROR', 'An error occurred while updating the Genre.');
        }
    }
    ...
    public function destroy(Genre $genre): JsonResponse
    {
        try {
            ...
            return $this->responseError(Response::HTTP_INTERNAL_SERVER_ERROR, 'INTERNAL_ERROR', 'An error occurred while deleting the Genre.');
        }
    }
